  ...
  return (
    <>
      <div className="md:h-28 w-full flex justify-between items-center p-2  box-border">
        <img src={LU} className="h-12 sm:h-16 md:h-15 lg:h-[5.27rem] ml-2" alt="Logo 1" />
        <img src={Name} className="h-12 sm:h-16 md:h-20 lg:h-20 " alt="Logo 2" />
        <div className='rounded-[50%] overflow-hidden mr-2'>
          <img src={A} className="h-12 sm:h-16 md:h-15 lg:h-20 bg-black " alt="Logo 3" />
        </div>
